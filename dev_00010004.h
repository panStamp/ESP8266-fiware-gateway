...
#ifndef _DEV_00010004_H
#define _DEV_00010004_H
 ...
 * Temperature sensor
 */
class DEV_00010004 : public GWAPDEVICE
{
  public:
    /**
     * Class constructor
     ...
     */
    inline DEV_00010004(GWAPPACKET *pkt) : GWAPDEVICE(pkt)
    {
    }
    ...
    inline bool getEndpointUlString(char *buf)
    {
      if (regId == 7)
      {
        if (payloadLen == 5)
        {
          ...
          sprintf(buf, "voltage|%.2f#temperature|%.2f", voltage, temperature);
          return true;
        }
      }
      return false;
